...
const Kapcsolatok = (props) => {
    ...
    const renderModal = () => {
        return (
            <Modal isOpen={modalOpen} toggle={toggleModal} size='lg' backdrop='static'>
                <ModalHeader>
                    {!currentId ? 'Kapcsolati bejegyzés hozzáadása' : 'Kapcsolati bejegyzés módosítása'} 
                </ModalHeader>
                <ModalBody>
    ...
    return (
        <div className='row'>
            <div className='col-md-12'>
                <Button color='success' onClick={() => handleNewClick()}>+ Kapcsolati bejegyzés hozzáadása</Button>
                <br /><br />
                {renderTable()}
                {renderModal()}
                {renderDeleteModal()}
