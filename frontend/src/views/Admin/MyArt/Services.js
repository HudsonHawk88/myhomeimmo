...
const myArtAltalanosAdminUrl = window.location.origin + "/api/admin/myart/altalanos";

const myArtGaleriakAdminUrl = window.location.origin + "/api/admin/myart/galeriak";
