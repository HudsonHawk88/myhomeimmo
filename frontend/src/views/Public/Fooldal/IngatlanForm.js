...
const IngatlanForm = () => {
    ...
    return (
        <Form>
            ...
            <br />
            <div className='col-md-12'>
                <Label>Az <a href='https://www.myhomeimmo.hu/adatkezeles' target='_blank'> adatkezelési tájékoztatót</a> megismertem, és hozzájárulok az abban rögzített adatkezelési célokból történő adatkezeléshez: *</Label>
                <Input
                    type='checkbox'
            ...
            <br />
            <div className='col-md-12'>
                <Button color='success' onClick={() => sendMail()} disabled={!elfogadAdatkezeles || mailForm.nev === '' || mailForm.telszam === '' || mailForm.email === '' || mailForm.statusz === ''}>
