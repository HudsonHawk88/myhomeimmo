...
const Kapcsolat = (props) => {
    ...
    const renderKapcsolat = () => {
        ...
        return kapcsolatok && kapcsolatok.length !== 0 && kapcsolatok.map((item, index) => {
            let kep = item.kep[0];
            return (  
                <div key={index.toString()}>
                    <div className='kapcsolati_adatok'>
                        ...
                        <div className='kapcsolat_alapadatok'>
                            <div className='kapcsolat_kep'>
                                ...
                                <div className='kapcsolat_terkep'>
                                    <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d10915.5994816901!2d16.845653!3d46.845661!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x5bcc4784fd93d883!2sMyhome%20Immo%20Kft.!5e0!3m2!1shu!2shu!4v1640359411151!5m2!1shu!2shu" width='100%' height='450px' style={{ border: 0 }} allowFullScreen={true} loading="lazy" />
                                </div>
                            </div>
                            <div className='kapcsolat_form'>
                                <div className='kapcsolat_form_leiras'>
                                    <h3>{item.kapcsolatcim}</h3><br />
    ...
    return (
        <div className='public_kapcsolat'>
            {renderKapcsolat()}
        </div>
    );
