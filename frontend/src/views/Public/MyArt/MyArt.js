...
const MyArt = (props) => {
    ...
    const renderKepek = (galeria) => {
        ...
        return kepek.map((kep) => {
            return (
                <img src={kep.src} alt={kep.filename} />
            );
        })
    }
                                ...
                                <div className='col-md-12'>
                                    ...
                                    <div className='row'>
                                        ...
                                        <div className='col-md-6'>
                                            ...
                                            <a href={galeria.muveszUrl} target='_blank'>{galeria.muveszUrl}</a>
                                        </div>
                                    </div>
                                </div>
    ...
    return (
        <div className='public_myart'>
            <div className='myart_altalanos' dangerouslySetInnerHTML={{__html: altalanos.leiras}} /><br />
            <div className='myart_galeriak'>
                {renderGaleriak()}
            </div>
        </div>
    );
